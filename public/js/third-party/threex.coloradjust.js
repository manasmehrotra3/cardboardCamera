...
THREEx.ColorAdjust.colorCubes	= {
	...
	'inverse' : 'inverse.png',
	'color-negative' : 'color-negative.png',
	'high-contrast-bw' : 'high-contrast-bw.png',
	'funky-contrast' : 'funky-contrast.png',
	'nightvision' : 'nightvision.png',
	'thermal' : 'thermal.png',
	'black-white' : 'black-white.png',
	'hue-plus-60' : 'hue-plus-60.png',
	'hue-plus-180' : 'hue-plus-180.png',
	'hue-minus-60' : 'hue-minus-60.png',
	'red-to-cyan' : 'red-to-cyan.png',
	'blues' : 'blues.png',
...
THREEx.ColorAdjust.Passes	= function(){
	...
	this.setColorCube	= function(value){
		...
		var uniforms = this.setColorCubeTexture(texture, cubeWidth)
		return uniforms;
	}
